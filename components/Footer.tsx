      ...
      <footer className="bg-gradient-to-b from-gray-50 to-white border-t border-gray-200" role="contentinfo">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="mt-4">
                <div className="flex space-x-3">
                  ...
                  <SocialMediaButton
                    ...
                    ariaLabel="Theo dõi NAGEN trên YouTube"
                    platform="youtube"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <SocialMediaButton
                    ...
                    ariaLabel="Theo dõi NAGEN trên TikTok"
                    platform="tiktok"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* SẢN PHẨM Column */}
            <div>
              <div className="font-bold text-[#21395D] mb-4 text-lg border-b-2 border-red-600 pb-2 inline-block">
                SẢN PHẨM
              </div>
